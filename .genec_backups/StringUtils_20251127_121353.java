...
public class StringUtils {
    ...
    /**
     * This is a 3 character version of an ellipsis. There is a Unicode character
     * for a HORIZONTAL ELLIPSIS, U+2026 … this isn't it.
     */
    ...
    /**
     * The default maximum depth at which recursive replacement will continue until
     * no further search replacements are possible.
     */
     ...
     * an {@link IllegalArgumentException}.</li>
     * <li>In no case will it return a String of length greater than
     * {@code maxWidth}.</li>
     * </ul>
     *
     ...
     * the time for all good men" into "...is the time for..." if "..." was
     ...
     * @since 3.2
     * @deprecated Use
     *             {@link Strings#appendIfMissing(String, CharSequence, CharSequence...)
     *             Strings.CS.appendIfMissing(String, CharSequence,
     *             CharSequence...)}.
     */
    @Deprecated
     ...
     * @deprecated Use
     *             {@link Strings#appendIfMissing(String, CharSequence, CharSequence...)
     *             Strings.CI.appendIfMissing(String, CharSequence,
     *             CharSequence...)}.
     */
    @Deprecated
     ...
     * A {@code null} String returns {@code null}. A negative size is treated as
     * zero.
     * </p>
     *
     * <p>
    ...
    /**
     * Tests if the CharSequence contains any character in the given set of
     * characters.
     *
     * <p>
    ...
    /**
     * Tests if the CharSequence contains any of the CharSequences in the given
     * array.
     *
     * <p>
     ...
     *                            null. Individual CharSequences may be
     *                            null as well.
     * @return {@code true} if any of the search CharSequences are found,
     *         {@code false} otherwise.
     * @since 3.4
     * @deprecated Use {@link Strings#containsAny(CharSequence, CharSequence...)
    ...
    public static int countMatches(final CharSequence str, final char ch) {
        ...
        int count = 0;
        // We could also call str.toCharArray() for faster lookups but that would
     ...
     *                   {@link #isBlank(CharSequence) blank} (whitespaces, empty
     *                   ({@code ""}) or
    ...
    /**
     * Returns either the given String, or if the String is {@code null},
     * {@code nullDefault}.
     *
     * <pre>
     ...
     * </pre>
     * <p>
     * Since this is now provided by Java, instead call
     ...
     *
     * @param str         the String to check, may be null.
     * @param nullDefault the default String to return if the input is {@code null},
     *                    may be null.
     ...
     * it's
     * different from the first. This means that the difference between "abc" and
     * "ab" is the empty String and not "c".
     *
     * <p>
     ...
     * @since 3.0
     * @deprecated Use {@link Strings#endsWithAny(CharSequence, CharSequence...)
     ...
     * Compares given {@code string} to a CharSequences vararg of
     * {@code searchStrings},
     * returning {@code true} if the {@code string} is equal to any of the
     * {@code searchStrings}, ignoring case.
     *
     * <pre>
     ...
     *         {@code false} if {@code searchStrings} is null or contains no
     *         matches.
     * @since 3.5
     * @deprecated Use {@link Strings#equalsAny(CharSequence, CharSequence...)
     ...
     * @param charset The {@link Charset} to encode the {@link String}. If null,
     *                then use the default Charset.
     ...
     *
     * @param string  input string.
     * @param charset The {@link Charset} name to encode the {@link String}. If
     *                null, then use the default Charset.
     * @return The empty byte[] if {@code string} is null, the result of
     *         {@link String#getBytes(String)} otherwise.
     * @throws UnsupportedEncodingException Thrown when the named charset is not
     *                                      supported.
     ...
     * <p>
     * For example,
     * {@code getCommonPrefix("i am a machine", "i am a robot") -&gt; "i am a "}
     * </p>
     *
     * <pre>
    ...
    /**
     * Gets the Fuzzy Distance which indicates the similarity score between two
     * Strings.
     *
     * <p>
     ...
     *                        input is {@link #isBlank(CharSequence) blank}
     *                        (whitespaces, empty
     ...
     * @param str             the CharSequence to check, may be null.
     * @param defaultSupplier the supplier of default CharSequence to return if the
     *                        input is empty ("") or {@code null}, may be null.
     * @return the passed in CharSequence, or the default.
     * @see StringUtils#defaultString(String, String)
     * @since 3.10
     */
    ...
    /**
     * Gets the Jaro Winkler Distance which indicates the similarity score between
     * two Strings.
     *
     * <p>
     ...
     * <a href=
     * "https://en.wikipedia.org/wiki/Jaro%E2%80%93Winkler_distance">https://en.wikipedia.org/wiki/Jaro%E2%80%93Winkler_distance</a>.
     * </p>
     *
     * <pre>
    ...
    /**
     * Gets the Levenshtein distance between two Strings if it's less than or equal
     ...
     * "https://web.archive.org/web/20120212021906/http%3A//www.merriampark.com/ld.htm">http://www.merriampark.com/ld.htm</a>
     * </p>
     *
     * <pre>
     * StringUtils.getLevenshteinDistance(null, *, *)             = IllegalArgumentException
    ...
    public static int getLevenshteinDistance(CharSequence s, CharSequence t, final int threshold) {
         ...
         * the
         * threshold value, returning -1 if it's greater. The advantage is performance:
         * unbounded
         * distance is O(nm), but a bound of k allows us to reduce it to O(km) time by
         * only
         * computing a diagonal stripe of width 2k + 1 of the cost table.
         * It is also possible to use this to compute the unbounded Levenshtein distance
         * by starting
         * the threshold at 1 and doubling each time until the distance is found; this
         * is O(dm), where
         * d is the distance.
         *
         ...
         * aren't
         * of the same size. Since string s is always swapped to be the shorter of the
         * two,
         * the stripe will always run off to the upper right instead of the lower left
         * of the matrix.
         *
         * As a concrete example, suppose s is of length 5, t is of length 7, and our
         * threshold is 1.
         * In this case we're going to walk a stripe of length 3. The matrix would look
         * like so:
         *
         * 1 2 3 4 5
         * 1 |#|#| | | |
         ...
         * allocating
         * an entire n by m matrix. This requires a few minor changes, such as
         * immediately returning
         * when it's detected that the stripe has run off the matrix and initially
         * filling the arrays with
    ...
    public static int indexOf(final CharSequence seq, final CharSequence searchSeq) {
		return StringReplacer.indexOf(seq, searchSeq);
	}
     ...
     * is treated as zero. An empty ("") search CharSequence always matches. A
    ...
    public static int indexOf(final CharSequence seq, final CharSequence searchSeq, final int startPos) {
		return StringReplacer.indexOf(seq, searchSeq, startPos);
	}
     ...
     * character sequence represented by {@code seq} {@link CharSequence} object,
     ...
     *
     * <p>
     * is true. For other values of {@code searchChar}, it is the smallest value
     * <em>k</em> such that:
     * </p>
     *
     * <pre>
     ...
     *
     * <p>
     * is true. In either case, if no such character occurs in {@code seq}, then
    ...
    public static int indexOf(final CharSequence seq, final int searchChar) {
		return StringReplacer.indexOf(seq, searchChar);
	}
     ...
     * represented by the {@code seq} {@link CharSequence} object at an index no
     ...
     *
     * <p>
     * is true. In either case, if no such character occurs in {@code seq} at or
     * after position {@code startPos}, then {@code -1} is returned.
     * </p>
     *
     * <p>
     * There is no restriction on the value of {@code startPos}. If it is negative,
     ...
     * effect as if it were equal to the length of this string:
     * {@code (INDEX_NOT_FOUND) -1} is returned. Furthermore, a {@code null} or
     * empty ("") CharSequence will return {@code (INDEX_NOT_FOUND) -1}.
     * </p>
     * <p>
    ...
    public static int indexOf(final CharSequence seq, final int searchChar, final int startPos) {
		return StringReplacer.indexOf(seq, searchChar, startPos);
	}
     ...
     * length search array will return {@code -1}. A {@code null} search array entry
     * will be ignored, but a search array containing "" will return {@code 0} if
     * {@code str} is not null. This method uses {@link String#indexOf(String)} if
     * possible.
     * </p>
     *
     * <pre>
     ...
     * given set of characters, i.e., find index i of first char in cs such that
     ...
     * given set of characters, i.e., find index i of first char in seq such that
    ...
    /**
     * Tests if any of the CharSequences are {@link #isBlank(CharSequence) blank}
     ...
     *
     * @param css the CharSequences to check, may be null or empty.
     * @return {@code true} if any of the CharSequences are
     *         {@link #isBlank(CharSequence) blank} (whitespaces, empty ({@code ""})
     *         or {@code null}).
     * @see #isBlank(CharSequence)
     * @since 3.2
     */
    ...
    public static boolean isEmpty(final CharSequence cs) {
		return StringReplacer.isEmpty(cs);
	}

    /**
     * Tests if the CharSequence contains mixed casing of both uppercase and
    ...
    /**
     * Tests if the CharSequence contains only Unicode digits. A decimal point is
    ...
    public static boolean isWhitespace(final CharSequence cs) {
        return StringSplitter.isWhitespace(cs);
    }
     ...
     * <p>
     * No delimiter is added before or after the list. Null objects or empty strings
     * within the array are represented
     * by empty strings.
     * </p>
     *
     * <pre>
    ...
    /**
     * Joins the elements of the provided {@link Iterable} into a single String
     ...
     * </p>
     *
     * @param iterable  the {@link Iterable} providing the values to join together,
     *                  may be null.
    ...
    /**
     * Joins the elements of the provided {@link Iterator} into a single String
     * containing the provided elements.
     *
     * <p>
     * No delimiter is added before or after the list. Null objects or empty strings
     ...
     * </p>
     *
     * @param iterator  the {@link Iterator} of values to join together, may be
     *                  null.
     * @param separator the separator character to use.
     * @return the joined String, {@code null} if null iterator input.
     * @since 2.0
    ...
    public static String join(final Iterator<?> iterator, final char separator) {
        ...
        return Streams.of(iterator).collect(LangCollectors.joining(ObjectUtils.toString(String.valueOf(separator)),
                EMPTY, EMPTY, ObjectUtils::toString));
    }
    ...
    public static String join(final Iterator<?> iterator, final String separator) {
        ...
        return Streams.of(iterator)
                .collect(LangCollectors.joining(ObjectUtils.toString(separator), EMPTY, EMPTY, ObjectUtils::toString));
    }
     ...
     * <p>
     * A {@code null} CharSequence will return {@code -1}. A negative start position
     * returns {@code -1}. An empty ("") search CharSequence always matches unless
     * the start position is negative. A start position greater than the string
     * length searches the whole string. The search starts at the startPos and works
     ...
     * @deprecated Use {@link Strings#lastIndexOf(CharSequence, CharSequence, int)
     *             Strings.CS.lastIndexOf(CharSequence, CharSequence, int)}.
     */
    @Deprecated
     ...
     *
     * <p>
     * is true. For other values of {@code searchChar}, it is the largest value
     * <em>k</em> such that:
     * </p>
     *
     * <pre>
     ...
     * {@link CharSequence} will return {@code -1}. The {@code seq}
     * {@link CharSequence} object is searched backwards starting at the last
     * character.
     * </p>
     *
     * <pre>
     ...
     * returned is the largest value <em>k</em> such that:
     *
     * <pre>
     * (this.charAt(<em>k</em>) == searchChar) &amp;&amp; (<em>k</em> &lt;= startPos)
     * </pre>
     ...
     * <p>
     * is true. In either case, if no such character occurs in {@code seq} at or
     * before position {@code startPos}, then {@code -1} is returned. Furthermore, a
     * {@code null} or empty ("") {@link CharSequence} will return {@code -1}. A
     * start position greater than the string length searches the whole string. The
     * search starts at the {@code startPos} and works backwards; matches starting
     ...
     * {@code str} if {@code str} is not null. This method uses
    ...
    /**
     * Finds the n-th last index within a String, handling {@code null}. This method
    ...
    public static int length(final CharSequence cs) {
		return StringReplacer.length(cs);
	}
     ...
     * current locale.
     * For platform-independent case transformations, the method
     ...
     * be returned without an exception. If the String is {@code null},
     * {@code null} will be returned. An empty String is returned if len is negative
     * or exceeds the length of {@code str}.
     * </p>
     *
     * <pre>
     ...
     * {@code {@link #trim(String)}} to remove leading and trailing whitespace and
     ...
     * <a href="https://www.w3.org/TR/REC-xml/#NT-S">S</a> production, which is S
     * ::= (#x20 |
     * #x9 | #xD | #xA)+
     * <p>
     ...
     * which this functional will also normalize. Additionally {@code {@link
     * #trim(String)}} removes control characters (char &lt;= 32) from both ends of
     * this String.
     * </p>
     *
    ...
    public static String normalizeSpace(final String str) {
        // LANG-1020: Improved performance significantly by normalizing manually instead
        // of using regex
        // See https://github.com/librucha/commons-lang-normalizespaces-benchmark for
        // performance test
        if (isEmpty(str)) {
            return str;
        }
     ...
     * <p>
     * <strong>Note:</strong> The code starts looking for a match at the start of
     * the target, incrementing the starting index by one after each successful
     * match
     * (unless {@code searchStr} is an empty string in which case the position is
     * never incremented and {@code 0} is returned immediately). This means that
     * matches may overlap.
     * </p>
     * <p>
     * A {@code null} CharSequence will return {@code -1}.
     ...
     * @param str       the CharSequence to check, may be null.
     * @param searchStr the CharSequence to find, may be null.
     * @param ordinal   the n-th {@code searchStr} to find, overlapping matches are
     *                  allowed.
     ...
     * @since 3.2
     * @deprecated Use
     *             {@link Strings#prependIfMissing(String, CharSequence, CharSequence...)
     *             Strings.CS.prependIfMissing(String, CharSequence,
     *             CharSequence...)}.
     */
    @Deprecated
     ...
     * @deprecated Use
     *             {@link Strings#prependIfMissing(String, CharSequence, CharSequence...)
     *             Strings.CI.prependIfMissing(String, CharSequence,
     *             CharSequence...)}.
     */
    @Deprecated
     ...
     * option
     * prepend {@code "(?s)"} to the regex. DOTALL is also known as single-line mode
     * in Perl.
     * </p>
     *
     * <pre>{@code
     ...
     *             RegExUtils.replaceFirst(String, String, EMPTY)}.
     */
    @Deprecated
    ...
    /**
     * Removes a char only if it is at the beginning of a source string, otherwise
     * returns the source string.
     *
     * <p>
     * A {@code null} source string will return {@code null}. An empty ("") source
     * string will return the empty string. A {@code null} search char will return
     * the source string.
     * </p>
     *
     * <pre>
    ...
    /**
     * Case-insensitive removal of a substring if it is at the beginning of a source
     * string, otherwise returns the source string.
     *
     * <p>
     * A {@code null} source string will return {@code null}. An empty ("") source
     ...
     * <a href="https://www.unicode.org/glossary/#supplementary_character">Unicode
     * Supplementary Characters</a>
     * as they require a pair of {@code char}s to be represented. If you are needing
     * to support full I18N of your applications consider using
    ...
    /**
     * Repeats a String {@code repeat} times to form a new String, with a String
    ...
    public static String replace(final String text, final String searchString, final String replacement) {
		return StringReplacer.replace(text, searchString, replacement);
	}
    ...
    public static String replace(final String text, final String searchString, final String replacement,
            final int max) {
				return StringReplacer.replace(text, searchString, replacement, max);
			}
    ...
    public static String replaceChars(final String str, final char searchChar, final char replaceChar) {
		return StringReplacer.replaceChars(str, searchChar, replaceChar);
	}
     ...
     * <p>
     * A {@code null} string input returns {@code null}. An empty ("") string input
     * returns an empty string. A null or empty set of search characters returns
     * the input string.
     * </p>
     *
     * <p>
    ...
    public static String replaceChars(final String str, final String searchChars, String replaceChars) {
		return StringReplacer.replaceChars(str, searchChars, replaceChars);
	}
    ...
    /**
     * Replace all occurrences of Strings within another String. This is a private
    ...
    public static String replaceIgnoreCase(final String text, final String searchString, final String replacement) {
		return StringReplacer.replaceIgnoreCase(text, searchString, replacement);
	}
    ...
    public static String replaceIgnoreCase(final String text, final String searchString, final String replacement,
            final int max) {
				return StringReplacer.replaceIgnoreCase(text, searchString, replacement, max);
			}
     ...
     * @since 3.5 Changed {@code null} reference passed to this method is a no-op.
     * @deprecated Use
     *             {@link RegExUtils#replacePattern(CharSequence, String, String)}.
     */
    @Deprecated
     ...
     * <p>
     * If {@code len} characters are not available, or the String is {@code null},
     * the String will be returned without an exception. An empty String is
    ...
    public static String[] split(final String str, final char separatorChar) {
		return StringSplitter.split(str, separatorChar);
	}
    ...
    public static String[] split(final String str, final String separatorChars) {
		return StringSplitter.split(str, separatorChars);
	}
    ...
    public static String[] split(final String str, final String separatorChars, final int max) {
		return StringSplitter.split(str, separatorChars, max);
	}
     ...
     * {@code java.lang.Character.getType(char)}. Groups of contiguous characters of
     * the same type are returned
     * as complete tokens, with the following exception: if {@code camelCase} is
     * {@code true}, the character of type {@code Character.UPPERCASE_LETTER}, if
     * any,
     * immediately preceding a token of type {@code Character.LOWERCASE_LETTER} will
     * belong to the following token rather than to the preceding, if any,
     ...
     * {@code java.lang.Character.getType(char)}. Groups of contiguous characters of
     * the same type are returned
     * as complete tokens, with the following exception: the character of type
     * {@code Character.UPPERCASE_LETTER}, if any, immediately preceding a token of
     * type
     * {@code Character.LOWERCASE_LETTER} will belong to the following token rather
     * than to the preceding, if any, {@code Character.UPPERCASE_LETTER} token.
     *
     * <pre>
    ...
    public static String[] splitPreserveAllTokens(final String str) {
        return StringSplitter.splitPreserveAllTokens(str);
    }
    ...
    public static String[] splitPreserveAllTokens(final String str, final char separatorChar) {
        return StringSplitter.splitPreserveAllTokens(str, separatorChar);
    }
    ...
    public static String[] splitPreserveAllTokens(final String str, final String separatorChars) {
        return StringSplitter.splitPreserveAllTokens(str, separatorChars);
    }
    ...
    public static String[] splitPreserveAllTokens(final String str, final String separatorChars, final int max) {
        return StringSplitter.splitPreserveAllTokens(str, separatorChars, max);
    }
    ...
    private static String[] splitWorker(final String str, final char separatorChar, final boolean preserveAllTokens) {
        return StringSplitter.splitWorker(str, separatorChar, preserveAllTokens);
    }
    ...
    private static String[] splitWorker(final String str, final String separatorChars, final int max,
            final boolean preserveAllTokens) {
        return StringSplitter.splitWorker(str, separatorChars, max, preserveAllTokens);
    }
     ...
     * @deprecated Use {@link Strings#startsWithAny(CharSequence, CharSequence...)
     ...
     * similar to {@link String#trim()} but allows the characters to be stripped
     * to be controlled.
     *
     * <p>
     ...
     * </p>
     * <p>
     * Decomposes ligatures and digraphs per the KD column in the
     * <a href = "https://www.unicode.org/charts/normalization/">Unicode
     * Normalization Chart.</a>
     * </p>
     *
     * <pre>
    ...
    public static String substring(final String str, int start) {
        return StringSplitter.substring(str, start);
    }
    ...
    public static String substring(final String str, int start, int end) {
        return StringSplitter.substring(str, start, end);
    }
     ...
     * @return the substring after the first occurrence of the specified character,
     *         {@code null} if null String input.
     * @since 3.11
     */
     ...
     * @return the substring after the first occurrence of the specified string,
     *         {@code null} if null String input.
     * @since 2.0
     */
     ...
     * @param str  the String to get a substring from, may be null.
     * @param find the character (Unicode code point) to find.
     * @return the substring before the first occurrence of the specified character,
     *         {@code null} if null String input.
     * @since 3.12.0
     */
     ...
     * @param str  the String to get a substring from, may be null.
     * @param find the String to find, may be null.
     * @return the substring before the first occurrence of the specified string,
     *         {@code null} if null String input.
     * @since 2.0
     */
     ...
     * surrogate) will be returned as-is.
     * </p>
     *
     * <pre>
     ...
     *
     * @param source A source String or null.
     * @return the given source String as an upper-case using the
     *         {@link Locale#ROOT} locale or null.
     * @since 3.10
     */
    ...
    public static String toString(final byte[] bytes, final String charsetName) {
		return StringReplacer.toString(bytes, charsetName);
	}
     ...
     * <p>
     * For a word based algorithm, see
     * {@link org.apache.commons.text.WordUtils#uncapitalize(String)}. A
     ...
     * current locale.
     * For platform-independent case transformations, the method
     * {@link #upperCase(String, Locale)} should be used with a specific locale
     * (e.g.
     * {@link Locale#ENGLISH}).
     * </p>
     *
    ...
    /**
     * {@link StringUtils} instances should NOT be constructed in standard
