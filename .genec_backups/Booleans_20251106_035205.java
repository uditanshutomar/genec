...
public final class Booleans {
  ...
  public static void reverse(boolean[] array) {
	BooleanArrayManipulator.reverse(array);
}
  ...
  public static void reverse(boolean[] array, int fromIndex, int toIndex) {
	BooleanArrayManipulator.reverse(array, fromIndex, toIndex);
}
  ...
  public static void rotate(boolean[] array, int distance) {
	BooleanArrayManipulator.rotate(array, distance);
}
  ...
  public static void rotate(boolean[] array, int distance, int fromIndex, int toIndex) {
	BooleanArrayManipulator.rotate(array, distance, fromIndex, toIndex);
}
}
