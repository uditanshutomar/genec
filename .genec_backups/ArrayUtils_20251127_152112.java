...
public class ArrayUtils {
    ...
    public static boolean[] add(final boolean[] array, final boolean element) {
		return ArrayExpansionUtils.add(array, element);
	}
    ...
    public static boolean[] add(final boolean[] array, final int index, final boolean element) {
		return ArrayExpansionUtils.add(array, index, element);
	}
    ...
    private static Object add(final Object array, final int index, final Object element, final Class<?> clazz) {
		return ArrayExpansionUtils.add(array, index, element, clazz);
	}
    ...
    public static boolean[] addFirst(final boolean[] array, final boolean element) {
		return ArrayExpansionUtils.addFirst(array, element);
	}
    ...
    public static <T> T arraycopy(final T source, final int sourcePos, final int destPos, final int length, final Function<Integer, T> allocator) {
		return ArrayExpansionUtils.arraycopy(source, sourcePos, destPos, length, allocator);
	}
    ...
    public static <T> T arraycopy(final T source, final int sourcePos, final T dest, final int destPos, final int length) {
		return ArrayExpansionUtils.arraycopy(source, sourcePos, dest, destPos, length);
	}
    ...
    public static boolean[] clone(final boolean[] array) {
		return ArrayExpansionUtils.clone(array);
	}
    ...
    private static Object copyArrayGrow1(final Object array, final Class<?> newArrayComponentType) {
		return ArrayExpansionUtils.copyArrayGrow1(array, newArrayComponentType);
	}
    ...
    public static <T> T get(final T[] array, final int index) {
		return ArrayExpansionUtils.get(array, index);
	}
    ...
    public static <T> T get(final T[] array, final int index, final T defaultValue) {
		return ArrayExpansionUtils.get(array, index, defaultValue);
	}
    ...
    public static <T> Class<T> getComponentType(final T[] array) {
		return ArrayExpansionUtils.getComponentType(array);
	}
    ...
    public static boolean[] insert(final int index, final boolean[] array, final boolean... values) {
		return ArrayExpansionUtils.insert(index, array, values);
	}
    ...
    private static boolean isArrayEmpty(final Object array) {
		return ArrayExpansionUtils.isArrayEmpty(array);
	}
    ...
    public static <T> boolean isArrayIndexValid(final T[] array, final int index) {
		return ArrayExpansionUtils.isArrayIndexValid(array, index);
	}
    ...
    public static boolean isEmpty(final boolean[] array) {
		return ArrayExpansionUtils.isEmpty(array);
	}
    ...
    public static boolean isSameLength(final boolean[] array1, final boolean[] array2) {
		return ArrayUtilities.isSameLength(array1, array2);
	}
    ...
    public static boolean isSorted(final boolean[] array) {
		return ArrayUtilities.isSorted(array);
	}
    ...
    public static <T> boolean isSorted(final T[] array, final Comparator<T> comparator) {
		return ArrayUtilities.isSorted(array, comparator);
	}
    ...
    private static <T, R, E extends Throwable> R[] map(final T[] array, final Class<R> componentType, final FailableFunction<? super T, ? extends R, E> mapper)
            throws E {
				return ArrayStringConverter.map(array, componentType, mapper);
			}
    ...
    public static <T> T[] newInstance(final Class<T> componentType, final int length) {
		return ArrayExpansionUtils.newInstance(componentType, length);
	}
...
//        }
    ...
    public static String toString(final Object array) {
		return ArrayStringConverter.toString(array);
	}
    ...
    public static String toString(final Object array, final String stringIfNull) {
		return ArrayStringConverter.toString(array, stringIfNull);
	}
    ...
    public static String[] toStringArray(final Object[] array) {
		return ArrayStringConverter.toStringArray(array);
	}
    ...
    public static String[] toStringArray(final Object[] array, final String valueForNullElements) {
		return ArrayStringConverter.toStringArray(array, valueForNullElements);
	}
