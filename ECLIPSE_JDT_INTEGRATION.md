...
- Numeric fields gain helper-side increment/decrement utilities; expressions like `++field` or `field++` translate to helper calls that preserve Java evaluation order.
