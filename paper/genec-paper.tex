...
\begin{itemize}
  ...
  \item \textbf{Verified suggestions extract 21.3\% of methods} (600 unique
        methods across 21 classes), with per-class coverage ranging from 2.3\%
        to 78.3\%.
...
GenEC extracted 600 unique methods out of 2,823 original methods (21.3\%
...
26.1\%. Five classes exceeded 50\% coverage: \texttt{ChartPanel} (78.3\%),
