...
class ProgressServer:
    ...
    def emit_progress(self, stage: int, total: int, message: str, details: dict | None = None):
        """
    ...
    def emit_error(self, error: str, details: dict | None = None):
...
_progress_server: ProgressServer | None = None
...
def emit_progress(stage: int, total: int, message: str, details: dict | None = None):
